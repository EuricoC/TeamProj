...
namespace Valve.VR.InteractionSystem
{
	...
	public class HoldingBlock : MonoBehaviour
	{
		...
		// all empty block spaces
		protected GameObject[] emptyBlocks;
		protected MeshRenderer emptyMesh;
        ...
        protected bool isOnEmptySpot = false;
        protected GameObject emptyBox;
        private Material highlight;

        //-------------------------------------------------
        protected virtual void Awake()
		{
			emptyBlocks =  GameObject.FindGameObjectsWithTag("emptyBlock");
			for (int i = 0; i < emptyBlocks.Length; i++)
			{
				emptyBlocks[i].SetActive(false);
			}
        ...
        protected virtual void OnAttachedToHand( Hand hand )
		{
			...
			for (int i = 0; i < emptyBlocks.Length; i++)
			{
				emptyBlocks[i].SetActive(true);
			}
			
			Debug.Log("Hold an object");
        ...
        {
	        if (other.CompareTag("emptyBlock"))
	        {
		        Debug.Log("now within empty block");
		        isOnEmptySpot = true;
		        emptyBox = other.gameObject;
		        emptyBox.GetComponent<Renderer>().material.color = new Color(1,1,0,1f);
        ...
        private void OnTriggerExit(Collider other)
        {
	        ...
	        {
		        isOnEmptySpot = false;
		        emptyBox.GetComponent<Renderer>().material.color = new Color(1,1,0,0.5f);
	        }
        }
	}
